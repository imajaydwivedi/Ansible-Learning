...
ansible-navigator run -m stdout ./ansible-core-concepts-and-advanced-features/using-ansible-playbooks/example.yml
...
ansible-navigator run ./ansible-core-concepts-and-advanced-features/using-ansible-playbooks/example.yml

...
-> Filters (like other plugins) are provide by collections.
...
ansible-playbook ansible-core-concepts-and-advanced-features/using-filters/password_hash.yaml
...
ansible-playbook ansible-core-concepts-and-advanced-features/using-filters/network.yaml
...
# ansible-playbook ansible-core-concepts-and-advanced-features/using-filters/filemap.yaml
...
ansible-playbook ansible-core-concepts-and-advanced-features/using-filters/subelements.yml
...
ansible-playbook ansible-core-concepts-and-advanced-features/using-filters/dict2items.yaml
...
ansible-playbook ansible-core-concepts-and-advanced-features/using-filters/selectattr.yaml
...
ansible-playbook ansible-core-concepts-and-advanced-features/using-filters/lab_using_filters.yml

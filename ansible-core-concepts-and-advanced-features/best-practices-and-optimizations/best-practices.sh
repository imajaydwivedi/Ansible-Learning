...
Example -
ansible-playbook ansible-core-concepts-and-advanced-features/best-practices-and-optimizations/tag-demo.yml
ansible-playbook ansible-core-concepts-and-advanced-features/best-practices-and-optimizations/tag-demo.yml --tag=first
ansible-playbook ansible-core-concepts-and-advanced-features/best-practices-and-optimizations/tag-demo.yml --tag=second
...
ansible-playbook ansible-core-concepts-and-advanced-features/best-practices-and-optimizations/copy-files.yaml
ansible server_ansible -a "ls -l /tmp/hosts"

# Install nginx on managed host, and check web_url locally
ansible-playbook ansible-core-concepts-and-advanced-features/best-practices-and-optimizations/delegation.yaml
...
ansible-playbook ansible-core-concepts-and-advanced-features/best-practices-and-optimizations/synchronize.yml
...
ansible-playbook ./ansible-core-concepts-and-advanced-features/best-practices-and-optimizations/copy.yml

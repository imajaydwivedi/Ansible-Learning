...
ansible-playbook ansible-core-concepts-and-advanced-features/managing-files/copy.yml
...
ansible-playbook ansible-core-concepts-and-advanced-features/managing-files/add_custom_facts.yml
...
ansible-playbook ansible-core-concepts-and-advanced-features/managing-files/change_config.yml
...
ansible-playbook ansible-core-concepts-and-advanced-features/managing-files/vsftpd-template.yml
...
ansible-playbook ansible-core-concepts-and-advanced-features/managing-files/hosts_info.yml
...
ansible-playbook ansible-core-concepts-and-advanced-features/managing-files/configure_etc_hosts.yml

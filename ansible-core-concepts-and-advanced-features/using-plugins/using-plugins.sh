...
ansible-playbook ansible-core-concepts-and-advanced-features/using-plugins/read-keys.yaml
ansible-playbook ansible-core-concepts-and-advanced-features/using-plugins/url.yaml
ansible-playbook ansible-core-concepts-and-advanced-features/using-plugins/users-with-password.yaml
...
ansible-playbook ansible-core-concepts-and-advanced-features/using-plugins/set-language.yaml
...
ansible-playbook ansible-core-concepts-and-advanced-features/using-plugins/lines.yaml
...
-> The "fileglob" lookup plugin can be used to iterate over a lit of files according to
    a globbing pattern
...
ansible-playbook ansible-core-concepts-and-advanced-features/using-plugins/fileglob-string.yaml
...
ansible-playbook ansible-core-concepts-and-advanced-features/using-plugins/wildcard-copy2.yaml
ansible-playbook ansible-core-concepts-and-advanced-features/using-plugins/wildcard-copy1.yaml
...
python ansible-core-concepts-and-advanced-features/using-plugins/check-cache.py

# check if facts are accessing without automating gathering
ansible-playbook ansible-core-concepts-and-advanced-features/using-plugins/check-facts.yaml
...
ansible-playbook ansible-core-concepts-and-advanced-features/using-plugins/test-ip.yml

...
ansible-playbook ansible-core-concepts-and-advanced-features/using-roles/nginx-role.yml
ansible-navigator run ansible-core-concepts-and-advanced-features/using-roles/nginx-role.yml
...
mkdir ./ansible-core-concepts-and-advanced-features/using-roles/roles
cd ./ansible-core-concepts-and-advanced-features/using-roles/roles
...
# run playbook
ansible-playbook ansible-core-concepts-and-advanced-features/using-roles/motd-role.yml
...
ansible-playbook ansible-core-concepts-and-advanced-features/using-roles/lab-exercise-nginx-role.yml
